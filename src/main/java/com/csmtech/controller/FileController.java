	...
	public ResponseEntity<Map<String, Object>> setTempFile(@RequestParam("file") MultipartFile file)
		...
		if (fileNameType != null) {
			...
			if (fileArray.length > 1) {
				...
				if(actualType.equals("mp4") || actualType.equals("avi") || 
						actualType.equals("wmv") || actualType.equals("mov") || 
						actualType.equals("flv") || actualType.equals("mpeg") || 
						actualType.equals("mkv") || actualType.equals("webm") || actualType.equals("3gp")) {
				f1 = new File(tempPath + "VIDEO" + "/" + fileNameType);
				}
				else {
					f1 = new File(tempPath + "DOCUMENT" + "/" + fileNameType);
				}
